...
{
  path: '/fluxPlatformManager',
  component: Layout,
  name: '贷超管理',
  icon:'excel',
  authority:'fluxPlatformManager',
  children: [
    {
      path: 'fluxPlatformAgentManager',
      component: _import('fluxPlat/agent/index'),
      name: '平台机构管理',
      authority:"fluxPlatformAgentManager"
    },
    {
      path: 'fluxPlatformProductManager',
      component: _import('fluxPlat/product/index'),
      name: '产品管理',
      authority:"fluxPlatformProductManager"
    }
  ]
}
];
